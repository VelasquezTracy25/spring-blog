...
INSERT INTO posts (date, title, description, body, slug, owner_id)
VALUES ('August 2020', 'Raising the Bar',
        ...
        once it’s opened for business in March.', 1,  1),
...
I asked for a camera when I was 5 years old and would wander the neighborhood hunting for photos, trying to be smart about using those 12 frames wisely. My interest in photography as art has grown steadily since then. The hunt for the image and experimentation with process remains a big draw.',4, 1 ),
...
The Aztecs believed that mourning the dead with tears would make the spirits’ path slippery and difficult to travel, so they honored loved ones with joy. With Emma’s altar, we carry on a 3,000-year tradition of remembering and welcoming.',5, 1),
...
View the video for more about Walsh’s thinking behind the allusions, symbolism and artifacts in the paintings, destined to hang in Supper’s dining room.',6,1)
;
