...
ALTER TABLE posts
    CHANGE COLUMN url slug VARCHAR(500);


ALTER TABLE posts
    CHANGE COLUMN body body VARCHAR(2000);

DELETE FROM posts WHERE id = 1;

INSERT INTO posts (date, title, description, body, slug)
VALUES ('August 2020','Raising the Bar',
        'Up, up and away… our new Poolside Provisions vintage truck took to the air, soaring (carefully) three stories to be installed beside the rooftop pool.',
