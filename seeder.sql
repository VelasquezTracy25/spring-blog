...
INSERT INTO posts (date, title, description, body, image, slug, owner_id)
VALUES ('August 2020', 'Raising the Bar',
        ...
        'It’s the culmination of an 18-month design and renovation feat tslughat’s given a 1960s-era Pearl beer truck new life as a poolside bar,
        geared up to satisfy our guests’ al fresco cravings for food and drink,
        once it’s opened for business in March.', '../static/img/1.jpg',1, 1),
...
I asked for a camera when I was 5 years old and would wander the neighborhood hunting for photos, trying to be smart about using those 12 frames wisely. My interest in photography as art has grown steadily since then. The hunt for the image and experimentation with process remains a big draw.','../static/img/3.jpg',3, 1 ),
...
The Aztecs believed that mourning the dead with tears would make the spirits’ path slippery and difficult to travel, so they honored loved ones with joy. With Emma’s altar, we carry on a 3,000-year tradition of remembering and welcoming.','../static/img/4.jpg', 4,1),
...
View the video for more about Walsh’s thinking behind the allusions, symbolism and artifacts in the paintings, destined to hang in Supper’s dining room.','../static/img/5.jpg',5,1),
       ('September 2017','What Emma and Otto Bring to the Table',
        'View the video for more about Walsh’s thinking behind the allusions, symbolism and artifacts in the paintings, destined to hang in Supper’s dining room.
',
        'Painter Lloyd Walsh is well-known in San Antonio’s art community (and beyond) for his idiosyncratic and beautiful work. Recently, he accepted a commission from us to paint portraits of Otto and Emma Koehler. Lloyd suggested that he represent the two Pearl titans as still-life paintings of tables, set with dishes, food and drink that reflects each founder’s history and personality. We loved the idea.

View the video for more about Walsh’s thinking behind the allusions, symbolism and artifacts in the paintings, destined to hang in Supper’s dining room.','../static/img/6.jpg',6,1)
;
